...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Usuari.contra'
        db.alter_column(u'usuaris_usuari', 'contra', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Usuari.contra'
        db.alter_column(u'usuaris_usuari', 'contra', self.gf('django.db.models.fields.TextField')(null=True))
    ...
    models = {
        ...
        u'usuaris.usuari': {
            ...
            'contra': ('django.db.models.fields.CharField', [], {'max_length': '10', 'null': 'True'}),
            ...
            'edat': ('django.db.models.fields.IntegerField', [], {'default': '927'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        }
    }
