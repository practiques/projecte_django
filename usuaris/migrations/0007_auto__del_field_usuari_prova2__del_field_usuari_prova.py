...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Usuari.prova2'
        db.delete_column(u'usuaris_usuari', 'prova2')
    ...
    def backwards(self, orm):
        # Adding field 'Usuari.prova2'
        db.add_column(u'usuaris_usuari', 'prova2',
                      self.gf('django.db.models.fields.CharField')(default='prova2', max_length=60),
                      keep_default=False)

        # Adding field 'Usuari.prova'
        db.add_column(u'usuaris_usuari', 'prova',
                      self.gf('django.db.models.fields.CharField')(default='prova', max_length=60, null=True),
                      keep_default=False)
