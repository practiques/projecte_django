...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'usuaris_usuari', 'contra_salt',
                      self.gf('django.db.models.fields.TextField')(default='QG9cGcmMmDDCFw06'),
                      keep_default=False)
    ...
    models = {
        ...
        u'usuaris.usuari': {
            ...
            'contra_salt': ('django.db.models.fields.TextField', [], {'default': "'QG9cGcmMmDDCFw06'"}),
            'correu': ('django.db.models.fields.EmailField', [], {'max_length': '75'}),
            'data_alta': ('django.db.models.fields.DateTimeField', [], {}),
            'edat': ('django.db.models.fields.IntegerField', [], {'default': '493'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'nom': ('django.db.models.fields.CharField', [], {'max_length': '30'})
        }
    }
